...
LiquidCrystal_I2C lcd(0x3F, 16, 2); //LCD Display(I2C) Object Declaration on Address 0x3F
									//in case of malfunction find the I2C address using I2C scanner
...
void FireMessage()
{
  ...
  delay(1000);
  SIM900A.println("Fire Detected");// Message content
...
void GasMessage()
{
  ...
  SIM900A.println("AT+CMGS=\"+8801700000000\"\r"); //Host mobile phone number to send message
  delay(1000);
  SIM900A.println("Gas Detected");// Message content
  SIM900A.println("System Entered into Emergency Mode!!");
  SIM900A.println((char)26);// ASCII code of CTRL+Z ; Indicates Termination of Text
  delay(1000);
};
void OCMessage()  //OverCurrent Message
{
  ...
  SIM900A.println("AT+CMGS=\"+8801700000000\"\r"); //Host mobile phone number to send message
  delay(1000);
  SIM900A.println("Over Current Detected into Main Power Line ");// Message content
  SIM900A.println("System Entered into Emergency Mode!!");
  SIM900A.println((char)26);// ASCII code of CTRL+Z ; Indicates Termination of Text
  delay(1000);
};
void MotionMessage()
{
  ...
  SIM900A.println("AT+CMGS=\"+8801700000000\"\r"); //Host mobile phone number to send message
  delay(1000);
  SIM900A.println("Unauthorized Motion Detected");// Message content
  SIM900A.println((char)26);// ASCII code of CTRL+Z ; Indicates Termination of Text
  delay(1000);
};
...
void setup() {
  delay(3000);//initial delay for GSM module
